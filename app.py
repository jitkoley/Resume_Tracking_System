...
st.set_page_config(page_title="ATS Systen Resume Pro")

st.title("Resume Tracking System" + ":snowflake:")
...
<div class="footer">
    <p>Developed with ❤ by <a style='display: block; text-align: center;' href="https://github.com/jitkoley?tab=repositories" target="_blank">Click for GitHub</a></p>
</div>
<div class="footer-left">
    <p>Developed by @Jit Koley</p>
</div>
"""
